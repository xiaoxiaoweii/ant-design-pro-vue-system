...
const api = {
  procurement: '/equipPurchase/query',
...
export function createProcurement (data) {
  /**
   *
   * @api {POST} /business/procurement/request 1. 创建购置申请
   * @apiName 1. 创建购置申请
   * @apiGroup PURCHASE
   * @apiVersion  1.0.0
   *
...
export function updateProcurement (data) {
  /**
   *
   * @api {POST} /business/procurement/request?_method=PUT 2. 修改购置申请
   * @apiName 2. 修改购置申请
   * @apiGroup PURCHASE
   * @apiVersion  1.0.0
   *
...
export function batchDeleteProcurement (data, parameter) {
  /**
   *
   * @api {POST} /business/procurement/request?_method=DELETE 3. 批量删除购置申请单
   * @apiName 3. 批量删除购置申请单
   * @apiGroup PURCHASE
   * @apiVersion  1.0.0
   *
...
export function submitProcurement (data) {
  /**
   *
   * @api {POST} /business/procurement/requestsubmit 4. 提交购置申请单
   * @apiName 4. 提交购置申请单
   * @apiGroup PURCHASE
   * @apiVersion  1.0.0
   *
...
export function cancelProcurement (data) {
  /**
   *
   * @api {POST} /business/procurement/cancel 4. 提交购置申请单
   * @apiName 4. 提交购置申请单
   * @apiGroup PURCHASE
   * @apiVersion  1.0.0
   *
...
export function getProcurementList (parameter) {
  /**
   *
   * @api {GET} /business/procurement 5. 查询购置申请列表
   * @apiName 5. 查询购置申请列表
   * @apiGroup PURCHASE
   * @apiVersion  1.0.0
   *
...
export function getDeviceList (parameter) {
  /**
   *
   * @api {GET} /business/procurement/detail 6. 查询购置申请单设备列表
...
export function handleProcurement (data, type, parameter) {
  switch (type) {
    case 'create':
      return createProcurement(data)
    case 'delete':
      return batchDeleteProcurement(data, parameter)
    case 'update':
      return updateProcurement(data)
    case 'retrieve':
      return getProcurementList(data, parameter)
    case 'submit':
      return submitProcurement(data)
    case 'cancel':
      return cancelProcurement(data)
    default:
      break
  }
}
