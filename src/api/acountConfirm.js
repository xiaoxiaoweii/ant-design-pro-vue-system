...
const api = {
  Account: '/finance/infos',
  queryone: '/finance/one',
  delete: '/Account/request?_method=delete',
  update: '/Account/request?_method=put',
  submit: '/Account/requestsubmit',
  detail: '/Account/detail',
  exportTopdf: '/finance/exportPDF',
  exportToexcel:'/finance/exportExcel',
  exportpdfList:'/finance/exportPDFList',
  exportexcelList:'/finance/exportExcelList'
}
...
export function createAccount (data) {
  /**
   *
   * @api {POST} /business/Account/request 1. 创建折旧单
   * @apiName 1. 创建折旧单
   * @apiGroup Account
   * @apiVersion  1.0.0
   *
...
export function batchDeleteAccount (data, parameter) {
  /**
   *
...
export function handleAccount (data, type, parameter) {
  switch (type) {
    case 'create':
      return createAccount(data)
    case 'delete':
      return batchDeleteAccount(data, parameter)
    case 'update':
      return updateAccount(data)
    case 'retrieve':
      return getAccountList(data, parameter)
    case 'submit':
      return submitAccount(data)
    case 'detail':
