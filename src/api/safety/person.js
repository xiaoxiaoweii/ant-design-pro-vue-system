...
const api = {
  purchase: '/equipSecurity/fuzzysearch',
  submit: '/equipSecurity/submit',
  edit: '/equipSecurity/update',
  cancel: '/equipSecurity/back',
  create: '/equipSecurity/save',
  delete: '/equipSecurity/delete',
  queryone: '/equipSecurity/queryOne',
