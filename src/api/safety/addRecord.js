...
const api = {
  purchase: '/tianChengRecord/fuzzysearch',
  submit: '/tianChengRecord/submit',
  edit: '/tianChengRecord/update',
  cancel: '/tianChengRecord/back',
  create: '/tianChengRecord/save',
  delete: '/tianChengRecord/delete',
  queryone: '/tianChengRecord/queryOne',
