...
const api = {
  purchase: '/tianChenPlan/fuzzysearch',
  submit: '/tianChenPlan/submit',
  edit: '/tianChenPlan/update',
  cancel: '/tianChenPlan/back',
  create: '/tianChenPlan/save',
  delete: '/tianChenPlan/delete',
  queryone: '/tianChenPlan/queryOne',
