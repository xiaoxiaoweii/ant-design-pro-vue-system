...
const api = {
  purchase: '/prejobSecurity/fuzzysearch',
  submit: '/prejobSecurity/submit',
  edit: '/prejobSecurity/update',
  cancel: '/prejobSecurity/back',
  create: '/prejobSecurity/save',
  delete: '/prejobSecurity/delete',
  queryone: '/prejobSecurity/queryOne',
