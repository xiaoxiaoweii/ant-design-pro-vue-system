...
const api = {
  purchase: '/problemCorrect/fuzzysearch',
  submit: '/problemCorrect/submit',
  edit: '/problemCorrect/update',
  cancel: '/prejobSecurity/back',
  create: '/problemCorrect/save',
  delete: '/problemCorrect/delete',
  queryone: '/problemCorrect/queryOne',
