...
const api = {
  purchase: '/dailyCheck/fuzzysearch',
  submit: '/dailyCheck/submit',
  edit: '/dailyCheck/update',
  cancel: '/dailyCheck/back',
  create: '/dailyCheck/save',
  delete: '/dailyCheck/delete',
  queryone: '/dailyCheck/queryOne',
