...
export default api
export function getNewspaperStopstartUpList (parameter) {//模糊查询
  return axios({
    url: api.fuzzySearch,
    method: 'get',
    params: parameter
...
export function saveNewspaperStopstartUp (data) { //保存
  return axios({
    url: api.save,
    method: 'post',
    data: jsonToFormData(data)
...
export function batchDeleteNewspaperStopstartUp (data, parameter) {//删除
  return axios({
    url: api.del,
    method: 'post',
    data: jsonToFormData(data),
...
export function updateNewspaperStopstartUp (data) {
  return axios({
    url: api.update,
    method: 'post',
    data: jsonToFormData(data)
...
export function retrieveNewspaperStopstartUp (data, parameter) {
  return axios({
    url: api.retrieve,
    method: 'post',
    data: jsonToFormData(data),
...
export function submitNewspaperStopstartUp (data) {
  return axios({
    url: api.submit,
    method: 'post',
    data: jsonToFormData(data)
...
export function handleNewspaperStopstartUp (data, type, parameter) {
  switch (type) {
    case 'save':
      return saveNewspaperStopstartUp(data)
    case 'delete':
      return batchDeleteNewspaperStopstartUp(data, parameter)
    case 'update':
      return updateNewspaperStopstartUp(data)
    case 'retrieve':
      return retrieveNewspaperStopstartUp(data, parameter)
    case 'submit':
      return submitNewspaperStopstartUp(data)
    default:
      break
  }
}
