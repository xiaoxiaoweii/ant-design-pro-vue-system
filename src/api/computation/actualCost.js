...
const api = {
  purchase: '/companyEngineering/fuzzysearch',
  submit: '/companyEngineering/submit',
  edit: '/companyEngineering/update',
  cancel: '/companyEngineering/back',
  create: '/companyEngineering/save',
  delete: '/companyEngineering/delete',
  queryone: '/companyEngineering/queryOne',
  exportExcel: '/companyEngineering/export',
  exportPdf: '/companyEngineering/exportPDF',
