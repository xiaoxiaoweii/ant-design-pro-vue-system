...
const api = {
  purchase: '/WaterElectricityDeduction/fuzzysearch',
  submit: '/WaterElectricityDeduction/submit',
  edit: '/WaterElectricityDeduction/update',
  cancel: '/WaterElectricityDeduction/back',
  create: '/WaterElectricityDeduction/save',
  delete: '/WaterElectricityDeduction/delete',
  queryone: '/WaterElectricityDeduction/queryOne',
  exportPdf: '/WaterElectricityDeduction/exportPDF',
  exportExcel: '/WaterElectricityDeduction/export',
  queryName: '/quote/queryName',
  querySubcontracto: '/selectCondInfo',
  querySubcontractoEndDate: '/WaterElectricityDeduction/querySubcontractoEndDate',
  queryWaterAndelectricity:'/WaterElectricityDeduction/queryWaterAndelectricity',
  approve: '/WaterElectricityDeduction/approve',
  reject: '/WaterElectricityDeduction/reject'
}
...
export const formSupLevelArray = [
  {
    text: '合格',
    value: '1'
  },
...
export function querySubcontractoEndDate (parameter) {
  return axios({
    url: api.querySubcontractoEndDate,
    method: 'get',
    params: parameter
  })
}

export function queryWaterAndelectricity (parameter) {
  return axios({
    url: api.queryWaterAndelectricity,
    method: 'get',
    params: parameter
  })
}

export function querySubcontracto (data) {
  return axios.post(api.querySubcontracto,data,{
...
export function exporToPdf (data) {
  /**
   *
   * @api {POST} /business/disassemble/export1. 导出数据到Excel
   * @apiName 1. 导出数据到Excel
