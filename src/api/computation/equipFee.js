...
const api = {
  purchase: '/costDeduction/fuzzysearch',
  submit: '/costDeduction/submit',
  edit: '/costDeduction/update',
  cancel: '/costDeduction/back',
  create: '/costDeduction/save',
  delete: '/costDeduction/delete',
  queryone: '/costDeduction/queryOne',
  exportExcel: '/costDeduction/export',
  exportPdf: '/costDeduction/exportPDF',
  queryName: '/quote/queryName',
  serial_number: '/material/create',
  querySubcontractoEndDate: '/costDeduction/querySubcontractoEndDate',
  querySubcontracto: '/selectCondInfo',
  queryMaterialAndRun:'/costDeduction/queryMaterialAndRun',
  approve: '/costDeduction/approve',
  reject: '/costDeduction/reject'
}
...
export function getQueryName (parameter) {
  return axios({
    url: api.queryName,
    method: 'get',
    params: parameter
...
export function getQueryOddNumbers (parameter) {
  return axios({
    url: api.queryOddNumbers,
    method: 'get',
    params: parameter
  })
}
export function getQueryQuantityAndUnit (parameter) {
  return axios({
    url: api.queryQuantityAndUnit,
    method: 'get',
    params: parameter
  })
}
...
export function queryMaterialAndRun (parameter) {
  return axios({
    url: api.queryMaterialAndRun,
    method: 'get',
    params: parameter
  })
}
