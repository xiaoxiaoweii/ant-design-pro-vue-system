...
const api = {
  purchase: '/analysis/fuzzysearch',
  submit: '/analysis/submit',
  edit: '/analysis/update',
  cancel: '/analysis/back',
  create: '/analysis/save',
  delete: '/analysis/delete',
  queryone: '/analysis/queryOne',
  exportExcel: '/analysis/export',
  exportPdf: '/analysis/exportPDF'
