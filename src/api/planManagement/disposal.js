...
const api = {
  purchase: '/materialReduce/fuzzysearch',
  submit: '/materialReduce/submit',
  edit: '/materialReduce/update',
  cancel: '/materialReduce/back',
  create: '/materialReduce/save',
  delete: '/materialReduce/delete',
  export: '/materialReduce/export',
  queryType: '/materialReduce/queryType',
  queryone:'/materialReduce/queryOne',
  approve:'/materialReduce/approve',
  reject:'/materialReduce/reject'
}
...
export function queryType (parameter) {
  return axios({
    url: api.queryType,
    method: 'get',
    params: parameter
