...
const api = {
  purchase: '/requirement/fuzzySearch',
  submit: '/requirement/submit',
  edit: '/requirement/update',
  cancel: '/requirement/back',
  create: '/requirement/save',
  delete: '/requirement/delete',
  queryone: '/requirement/queryOne',
  exportPDF: '/requirement/exportPDF',
  export: '/requirement/export',
  queryByEquipment: '/selectCategoryInfo',
  approve:'/requirement/approve',
  refuse:'/requirement/reject',
