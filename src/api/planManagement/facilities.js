...
const api = {
  purchase: '/demolition/fuzzysearch',
  submit: '/demolition/submit',
  edit: '/demolition/update',
  cancel: '/demolition/back ',
  create: '/demolition/save',
  delete: '/demolition/delete',
  queryone: '/demolition/queryOne',
  queryTaxRate: '/disassemble/queryTaxRate',
  export: '/demolition/export',
  approve:'/demolition/approve',
  reject:'/demolition/reject'
}
...
export function handleFacility (data, type, parameter) {
  switch (type) {
    case 'create':
