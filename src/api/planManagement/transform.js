...
const api = {
  purchase: '/transform/fuzzysearch',
  submit: '/transform/submit',
  edit: '/transform/update',
  cancel: '/transform/back',
  create: '/transform/save',
  delete: '/transform/delete',
  queryone: '/transform/queryOne',
  queryTaxRate: '/transform/queryTaxRate',
  export: '/transform/export',
  approve:'/transform/approve',
  reject:'/transform/reject'
}
...
export function handleTransform (data, type, parameter) {
  switch (type) {
    case 'create':
