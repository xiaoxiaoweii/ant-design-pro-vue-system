...
const api = {
  purchase: '/accessory/fuzzysearch',
  submit: '/accessory/submit ',
  edit: '/accessory/update ',
  cancel: '/accessory/back',
  create: '/accessory/save',
  delete: '/accessory/delete',
  queryone: '/accessory/queryOne',
  queryTaxRate: '/accessory/queryTaxRate',
  export: '/accessory/export',
  serial_number: '/material/create',
  queryMaterial:'/accessory/queryMaterial',
  approve:'/accessory/approve',
  reject:'/accessory/reject'
}
...
export function exportToExcel (data) {
  /**
   *
   * @api {POST} /business/accessory/export 1. 导出数据到Excel
...
export function createRequire (data) {
  /**
   *
   * @api {POST} /business/accessory/save 1. 创建设备材料配件采购申请表
   * @api {POST} /business/requirement/queryplan 1. 创建设备材料配件采购申请表
   * @apiName 1. 创建设备材料配件采购申请
   * @apiGroup PURCHASE
   * @apiVersion  1.0.0
   *
   *
...
export function updatePurchase (data) {
  /**
   *
   * @api {POST} /business/accessory/update 2. 修改配件采购
   * @api {POST} /business/purchase/request?_method=PUT 2. 修改配件采购
   * @apiName 2. 修改配件采购
   * @apiGroup PURCHASE
   * @apiVersion  1.0.0
   *
...
export function submitRequire (data) {
  /**
   *
   * @api {POST} /business/accessory/submit 4. 提交需求计划表
...
export function cancelPurchase (data) {
  /**
   *
   * @api {POST} /business/accessory/back 4. 提交需求计划表
   * @apiName 4. 提交需求计划表
   * @apiGroup PURCHASE
   * @apiVersion  1.0.0
   *
...
export function getPurchaseList (parameter) {
  /**
   *
   * @api {GET} /business/accessory/fuzzysearch  5. 查询配件采购列表
   * @apiName 5. 查询配件采购列表
   * @apiGroup PURCHASE
   * @apiVersion  1.0.0
   *
   ...
   * "msg": "查询成功",
    ...
    "responsePageInfo": {
        ...
        "list": [
            {
                "creator_user_id": 1,
                "creator_user_name": "ww",
                "updated_at": "2019-08-22 11:28:43",
                "sum_with_tax": 2.50,
                "creator_org_name": "qq",
                "created_at": "2019-08-22 11:28:43",
                "serial_number": "10943b79-9423-4e7b-9c18-3d161deb1f86",
                "remark": "123456",
                "creator_org_id": 1,
...
export function queryone (parameter) {
  /**
   *
   * @api {GET} /business/accessory/queryOne  6. 查询配件所有信息
   * @apiName 6. 查询配件所有信息
   * @apiGroup PURCHASE
   * @apiVersion  1.0.0
   *
        ...
        "detail": [
            {
                ...
                "unit": "元",
                "tax_fee": 1.20,
                "planned_arrival_date": "2019-08-22",
                "sum_with_tax": 2.50,
                "name": "ee",
                "id": 1,
                "material_code": "1"
...
export function handleMaterial (data, type, parameter) {
  switch (type) {
    case 'create':
