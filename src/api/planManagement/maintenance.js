...
const api = {
  purchase: '/repair/fuzzysearch',
  submit: '/repair/submit',
  edit: '/repair/update',
  cancel: '/repair/back',
  create: '/repair/save',
  delete: '/repair/delete',
  queryone: '/repair/queryOne',
  export: '/repair/export',
  queryByCode:'/repair/queryByCode',
...
export function handleMaintenance (data, type, parameter) {
  switch (type) {
    case 'create':
