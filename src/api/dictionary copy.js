...
const api = {
  dictionary: '/vehicleCost/vehicleCheck?pageSize=15&pageNum=1',
  enum: '/vehicleCost/vehicleCheck',
  equip:'/equipRepair/maintain'
}
...
export function getDictionaryEquip (parameter) {
  /**
   *
   * @api {GET} /business/dictionary/single?dic_type_id=1004 2. 查询字典枚举
   * @apiName 2. 查询字典枚举
