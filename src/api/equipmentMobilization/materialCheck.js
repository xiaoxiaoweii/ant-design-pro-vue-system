...
const api = {
  purchase: '/materialCheck/fuzzysearch',
  submit: '/materialCheck/submit',
  edit: '/materialCheck/update',
  cancel: '/materialCheck/back',
  create: '/materialCheck/save',
  delete: '/materialCheck/delete',
  queryone: '/materialCheck/queryOne',
  queryTaxRate: '/materialCheck/queryTaxRate',
  queryPurchasePrivi: '/materialCheck/queryPurchasePrivi',
  queryMaterialType: '/materialCheck/queryMaterialType',
  query: '/materialCheck/query',
  // 导出pdf
  exportPDF: '/materialCheck/exportPDF',
  // 导出pdf列表
  exportPDFList: '/materialCheck/exportPDFList',
  // 导出excel
  exportExcel: '/materialCheck/export',
  // 导出excel列表
  exportExcelList: '/materialCheck/exportExcelList',
  approve: '/materialCheck/approve',
  materialByContract: '/materialCheck/queryByContract',
  reject: '/materialCheck/reject'
}

export default api

export function materialByContract (parameter) {
  return axios({
    url: api.materialByContract,
    method: 'get',
    params: parameter
  })
}
...
export function getQueryPurchasePrivi (parameter) {
  return axios({
    url: api.queryPurchasePrivi,
    method: 'get'
  })
}
export function getQueryMaterialType (parameter) {
  return axios({
    url: api.queryMaterialType,
    method: 'get'
  })
}
export function getRead (parameter) {
  return axios({
    url: api.query,
    method: 'post',
    params: parameter
