...
const api = {
  purchase: '/InstallCheck/fuzzysearch',
  submit: '/InstallCheck/submit',
  edit: '/InstallCheck/update',
  cancel: '/InstallCheck/back',
  create: '/InstallCheck/save',
  delete: '/InstallCheck/delete',
  queryone: '/InstallCheck/queryOne',
  queryTaxRate: '/transform/queryTaxRate',
  queryByCode: '/InstallCheck/queryByCode',
  queryResult: '/InstallCheck/queryResult',
  queryCheckItem: '/InstallCheck/queryCheckItem',
  // 导出pdf
  exportPDF: '/InstallCheck/exportPDF',
  // 导出pdf列表
  exportPDFList: '/InstallCheck/exportPDFList',
  // 导出excel
  exportExcel: 'InstallCheck/exportExcel',
  // 导出excel列表
  exportExcelList: '/InstallCheck/exportExcelList',
  approve: '/InstallCheck/approve',
  reject: '/InstallCheck/reject'
}
