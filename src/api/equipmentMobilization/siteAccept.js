...
const api = {
  purchase: '/checkEquip/fuzzysearch',
  queryProjectName: '/quote/queryProjectName',
  submit: '/checkEquip/submit',
  edit: '/checkEquip/update',
  cancel: '/checkEquip/back',
  create: '/checkEquip/save',
  delete: '/checkEquip/delete',
  queryone: '/checkEquip/queryOne',
  ...
  queryTransfer: '/checkEquip/queryTransfer',
  query: '/checkEquip/query',
  queryCheckItem: '/checkEquip/queryCheckItem',
  queryIntervalUnit: 'checkEquip/queryIntervalUnit',
  queryEmploy: '/checkEquip/queryEmploy',
  queryState: '/checkEquip/queryState',
  approve: '/checkEquip/approve',
  reject: '/checkEquip/reject'
}
...
export function getQuerySource (parameter) {
  return axios({
    url: api.querySource,
    method: 'get'
  })
}
export function getQueryCheckItem (parameter) {
  return axios({
    url: api.queryCheckItem,
    method: 'get',
    params: parameter
  })
}
...
export function getQueryIntervalUnit (parameter) {
  return axios({
    url: api.queryIntervalUnit,
    method: 'get'
  })
}
export function getQuerystate (parameter) {
  return axios({
    url: api.queryState,
    method: 'get'
  })
}
export function getQueryemploy (parameter) {
  return axios({
    url: api.queryEmploy,
    method: 'get'
  })
...
// 使用部位
export function getQueryProjectName (parameter) {
  return axios({
    url: api.queryProjectName,
    method: 'get'
  })
}
