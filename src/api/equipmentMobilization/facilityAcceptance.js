...
const api = {
  purchase: '/facilityCheck/fuzzysearch',
  submit: '/facilityCheck/submit',
  edit: '/facilityCheck/update',
  cancel: '/facilityCheck/back',
  create: '/facilityCheck/save',
  delete: '/facilityCheck/delete',
  queryone: '/facilityCheck/queryOne',
  queryTaxRate: '/disassemble/queryTaxRate',
  export: '/disassemble/export',
  exportPDF: '/facilityCheck/exportPDF',
  queryResult: '/facilityCheck/queryResult',
  queryCheckItem: '/facilityCheck/queryCheckItem',
  querySource: '/facilityCheck/querySource',
  approve: '/facilityCheck/approve',
  reject: '/facilityCheck/reject'
}
...
export function exportToPDF (data) {
  /**
   *
   * @api {POST} /business/disassemble/export1. 导出数据到pdf
   * @apiName 1. 导出数据到pdf
   * @apiGroup COMMON
   * @apiVersion  1.0.0
   *
