...
const api = {
  purchase: '/VehicleCheck/fuzzysearch',
  submit: '/VehicleCheck/submit',
  edit: '/VehicleCheck/update',
  cancel: '/VehicleCheck/back',
  create: '/VehicleCheck/save',
  delete: '/VehicleCheck/delete',
  queryone: '/VehicleCheck/queryOne',
  query: '/VehicleCheck/query',
  queryCarNo: '/VehicleCheck/queryCarNo',
  // 导出pdf
  exportPDF: '/VehicleCheck/exportPDF',
  // 导出pdf列表
  exportPDFList: '/VehicleCheck/exportPDFList',
  // 导出excel
  exportExcel: '/VehicleCheck/exportExcel',
  // 导出excel列表
  exportExcelList: '/VehicleCheck/exportExcelList',
  approve: '/VehicleCheck/approve',
  reject: '/VehicleCheck/reject'
}
...
export function getQueryCarNo (parameter) {
  return axios({
    url: api.queryCarNo,
    method: 'get'
  })
