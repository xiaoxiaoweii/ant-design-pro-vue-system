...
const api = {
  apitalMaterial: '/materialCost/request',
  submit: '/materialCost/save',
  edit: '/materialCost/one',
  // del: '/materialCost/del',
  cancel: '/materialCost/cancel',
  commit: '/materialCost/requestsubmit',
  update: '/materialCost/update',
  // schedule: '/materCharge/schedule',
  // purchase: '/materCharge/purchase',
  // materialType: '/materCharge/materialType',
  export: '/materialCost/export',
  history: '/materialCost/history',
  ledger: '/materialCost/check',
  settleDate: '/materialCost/settleDate',
  supplier: '/materialCost/supplier',
  amount: '/materialCost/amount',
  approve: '/materialCost/approve',
  reject: '/materialCost/reject'
}
