...
const api = {
  apitalMaterial: '/vehicleCost/request',
  submit: '/vehicleCost/save',
  edit: '/vehicleCost/one',
  // del: '/vehicleCost/del',
  cancel: '/vehicleCost/cancel',
  commit: '/vehicleCost/requestsubmit',
  update: '/vehicleCost/update',
  // schedule: '/materCharge/schedule',
  // purchase: '/materCharge/purchase',
  // materialType: '/materCharge/materialType',
  export: '/vehicleCost/export',
  history: '/vehicleCost/history',
  amount: '/vehicleCost/amount',
  approve: '/vehicleCost/approve',
  reject: '/vehicleCost/reject'
}
