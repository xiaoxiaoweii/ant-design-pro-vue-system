...
const api = {
  apitalMaterial: '/equipClearingFee/request',
  submit: '/equipClearingFee/save',
  edit: '/equipClearingFee/one',
  // del: '/equipClearingFee/del',
  cancel: '/equipClearingFee/cancel',
  commit: '/equipClearingFee/requestsubmit',
  update: '/equipClearingFee/update',
  // schedule: '/materCharge/schedule',
  // purchase: '/materCharge/purchase',
  // materialType: '/materCharge/materialType',
  export: '/equipClearingFee/export',
  history: '/equipClearingFee/history',
  ledger: '/equipClearingFee/check',
  settleDate: '/equipClearingFee/settleDate',
  supplier: '/equipClearingFee/total',
  amount: '/equipClearingFee/amount',
  approve: '/equipClearingFee/approve',
  reject: '/equipClearingFee/reject'
}

export default api

export function settleDate (parameter) {
  return axios({
    url: api.settleDate,
    method: 'get',
    params: parameter
