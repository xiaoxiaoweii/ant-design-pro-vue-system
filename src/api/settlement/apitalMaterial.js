...
const api = {
  apitalMaterial: '/materialAmortization/request',
  submit: '/materialAmortization/save',
  edit: '/materialAmortization/one',
  // del: '/materialAmortization/del',
  cancel: '/materialAmortization/cancel',
  commit: '/materialAmortization/requestsubmit',
  update: '/materialAmortization/update',
  // schedule: '/materCharge/schedule',
  // purchase: '/materCharge/purchase',
  // materialType: '/materCharge/materialType',
  export: '/materialAmortization/export',
  history: '/materialAmortization/history',
  check: '/materialAmortization/check',
  approve: '/materialAmortization/approve',
  reject: '/materialAmortization/reject'
}
