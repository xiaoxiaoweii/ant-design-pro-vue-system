...
const api = {
  apitalMaterial: '/leaseSettlement/request',
  submit: '/leaseSettlement/save',
  edit: '/leaseSettlement/one',
  // del: '/leaseSettlement/del',
  cancel: '/leaseSettlement/cancel',
  commit: '/leaseSettlement/requestsubmit',
  update: '/leaseSettlement/update',
  // schedule: '/materCharge/schedule',
  // purchase: '/materCharge/purchase',
  // materialType: '/materCharge/materialType',
  export: '/leaseSettlement/export',
  history: '/leaseSettlement/history',
  ledger: '/leaseSettlement/ledger',
  supplier: '/leaseSettlement/supplier',
  amount: '/leaseSettlement/amount',
  approve: '/leaseSettlement/approve',
  reject: '/leaseSettlement/reject'
}
