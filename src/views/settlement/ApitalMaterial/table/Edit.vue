...
export default {
  ...
  mounted () {
    // getCheck({ pageSize: 13, pageNum: 1, scope_code: this.$store.state.menu_key || this.$store.state.user.first_key })
    // getHistory({ pageSize: 13, pageNum: 1, scope_code: this.$store.state.menu_key || this.$store.state.user.first_key }).then(res => {
