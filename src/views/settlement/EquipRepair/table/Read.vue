<template>
  <div>
    ...
    >
      <detail-list>
        <detail-list-item term="单据编号">{{ recording.request_code }}</detail-list-item>
        <detail-list-item term="编制人">{{ recording.creator_user_name }}</detail-list-item>
        <detail-list-item term="金额">{{ recording.total_amount }}</detail-list-item>
        <detail-list-item term="购置理由">{{ recording.reason }}</detail-list-item>
      </detail-list>
    </a-card>
...
import { getDeviceList, handlePurchase } from '@/api/purchase'
