<template>
  <div>
    <a-card class="card" title="设备维修结算单" :bordered="false">
      <a-form :form="form">
        <a-row :gutter="16">
          <a-col :span="8">
    ...
    >
      <div class="attachment" v-if="activeTabKey === 'attach'">
        <a-upload-dragger
          ...
          :fileList="fileList"
          @change="fileChange"
          :data="{model:'E007', type: 0, menu_id: 59}"
        >
...
import {
  ...
  getAmount,
  // getMaterialType
} from '@/api/settlement/equipRepair'
...
export default {
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          align: 'center',
          scopedSlots: { customRender: 'repair_item' }
        },
        {
          title: '不含税单价',
          dataIndex: 'price',
  ...
  methods: {
    ...
    handleGoBack () {
      ...
      this.$router.push('equipRepairList')
    },
    ...
    loadEditInfo (data) {
      ...
      if (data.id) {
        ...
        getDeviceList({ id: data.id, menu_id: 59 }).then(res => {
    ...
    newDevice () {
      ...
      this.detailData.push({
        ...
        settlement_amount: this.data_sum('settlement_amount'),
