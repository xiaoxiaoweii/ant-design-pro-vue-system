...
// 动态切换组件
import List from '@/views/settlement/MonthlyCapital/table/List'
import Edit from '@/views/settlement/MonthlyCapital/table/Edit'
import Read from '@/views/settlement/MonthlyCapital/table/Read'
