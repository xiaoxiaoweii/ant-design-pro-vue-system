...
// 动态切换组件
import List from '@/views/equipExit/leaseOut/table/List'
import Edit from '@/views/equipExit/leaseOut/table/Edit'
import Detail from '@/views/equipExit/leaseOut/table/Detail'
export default {
  name: 'PlanExitList',
  components: {
    List,
