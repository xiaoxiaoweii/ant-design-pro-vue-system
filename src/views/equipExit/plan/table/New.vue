        ...
        if (!err) {
          this.$confirm({
            ...
            onOk: () => {
              ...
              // TODO: 编制单位,工程名称？
              return handleEquipOutPlan(type === 'save' ? 'create' : 'submit', Object.assign({ scope_code: this.scopeCode, menu_id: this.menuCode }, values, { create_date: values.create_date.format('YYYY-MM-DD'), pro_unit_code: this.$store.state.pro_unit_code, creator_org_id: this.scopeCode })).then(res => {
