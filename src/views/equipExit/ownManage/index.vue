...
// 动态切换组件
import List from '@/views/equipExit/ownManage/table/List'
import Edit from '@/views/equipExit/ownManage/table/Edit'
import Detail from '@/views/equipExit/ownManage/table/Detail'
export default {
  name: 'OwnEquipmentExitList',
  components: {
    List,
    Edit,
    Detail
