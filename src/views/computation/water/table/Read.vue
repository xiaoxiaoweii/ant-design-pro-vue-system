...
import { handlePurchase, submitRequire,queryone,queryTaxRate,getSerialNumber} from '@/api/computation/water'
      ...
      columnsSum: [
       {
        ...
        {
          title: '单位工程名称',
          dataIndex: 'engineering_name1',
          key: 'engineering_name1',
          width: '200px',
          align: 'center'
        },
        {
          title: '上期数量',
          dataIndex: 'previous_amount1',
          key: 'previous_amount1',
          width: '150px',
          align: 'center'
        },
        {
          title: '本期数量',
          dataIndex: 'current_amount1',
          key: 'current_amount1',
          width: '150px',
          align: 'center'
        },
        {
          title: '实际消耗数量',
          dataIndex: 'actual_consumption1',
          key: 'actual_consumption1',
          width: '150px',
          align: 'center' 
        },
        {
          title: '定额超耗数量',
          dataIndex: 'quota_consumption1',
          key: 'quota_consumption1',
          width: '150px',
          align: 'center'
        },
        {
          title: '超耗数量',
          dataIndex: 'above_amount1',
          key: 'above_amount1',
          width: '150px',
          align: 'center'
        },
