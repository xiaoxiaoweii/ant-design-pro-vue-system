...
import { handlePurchase, submitRequire, 
queryone,querySubcontracto,querySubcontractoEndDate,
queryWaterAndelectricity,formSupTypeArray,
formSupLevelArray } from '@/api/computation/water'
