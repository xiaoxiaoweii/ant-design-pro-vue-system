<template>
  <div>
    ...
    >
      <detail-list>
        <detail-list-item term="表单编号">{{ recording.form_number }}</detail-list-item>
        <detail-list-item term="编制单位">{{ recording.creator_org_name }}</detail-list-item>
        <detail-list-item term="时间范围">{{ `${recording.start_time}-${recording.end_time}` }}</detail-list-item>
        <detail-list-item term="制表日期">{{ recording.create_date }}</detail-list-item>
      </detail-list>
    </a-card>
