  ...
  <div>
    ...
    >
      <detail-list>
        ...
        <detail-list-item term="委托方">{{ recording.client }}</detail-list-item>
        ...
        <detail-list-item term="承运方">{{ recording.carrier }}</detail-list-item>
        <detail-list-item term="货物名称">{{ recording.goods_name }}</detail-list-item>
        <detail-list-item term="发运地点">{{ recording.begin_site }}</detail-list-item>
        <detail-list-item term="编制人">{{ recording.creator_user_name }}</detail-list-item>
        <detail-list-item term="编制日期">{{ recording.create_date }}</detail-list-item>
        <detail-list-item term="承运方">{{ recording.carrier }}</detail-list-item>
      </detail-list>
...
import { getDeviceList, handlePurchase, submitRequire,queryone,queryTaxRate} from '@/api/planManagement/transform'
...
export default {
  ...
  data () {
    return {
      ...
      detailFields: ['num', 'unit','price_without_tax','tax_rate','total_tax','price_without_tax','sum_with_tax', 'total_without_tax','remark','fee_item'],
      sumData:[{
        all_total: '合计',
        num1: '',
        sum_with_tax1:'',
      ...
      columnsSum: [
        ...
        {
          title: '不含税金额',
          dataIndex: 'total_without_tax1',
          key: 'total_without_tax1',
          width: '150px',
          align: 'center',
          scopedSlots: { customRender: 'total_without_tax1' }
        },
        {
          title: '税率(%)',
          dataIndex: 'tax_rate1',
        ...
        {
          title: '税额',
          dataIndex: 'total_tax1',
          key: 'total_tax1',
          width: '100px',
          align:'center',
          scopedSlots: { customRender: 'total_tax1' }
        ...
        },
        {
          ...
          width: '150px',
          align:'center',
          scopedSlots: { customRender: 'sum_with_tax1' }
