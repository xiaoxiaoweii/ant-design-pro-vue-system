...
// 动态切换组件
import List from '@/views/planManagement/Rental/table/List'
import Edit from '@/views/planManagement/Rental/table/Edit'
import Detail from '@/views/planManagement/Rental/table/Detail'
export default {
  name: 'Rental',
  components: {
    AInput,
