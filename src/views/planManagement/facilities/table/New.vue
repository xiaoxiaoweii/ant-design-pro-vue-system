...
import { handleFacility, exportToExcel, exportToPDF } from '@/api/planManagement/facilities'
import {
  uploadUrl,
  getAttachments,
  downloadAttachment,
...
export default {
  ...
  data() {
    return {
      ...
      detailData: [],
      columnsTitle: [
        '设备名称','设备编码','规格型号','单位','数量','不含税单价(元)','税率(%)',
        ...
        validateFields((err, values) => {
          if (!err) {
            ...
            if (type === 'submit') {
              ...
              return handleFacility(values, 'create').then(res => {
