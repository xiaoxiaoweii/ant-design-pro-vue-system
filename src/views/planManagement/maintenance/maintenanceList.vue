...
// 动态切换组件
import List from '@/views/planManagement/maintenance/table/List'
import Edit from '@/views/planManagement/maintenance/table/Edit'
import Read from '@/views/planManagement/maintenance/table/Read'
import Detail from '@/views/planManagement/maintenance/table/Detail'
export default {
