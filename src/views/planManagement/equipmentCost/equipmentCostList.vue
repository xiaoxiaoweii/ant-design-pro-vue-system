...
// 动态切换组件
import List from '@/views/planManagement/equipmentCost/table/List'
import Edit from '@/views/planManagement/equipmentCost/table/Edit'
import Detail from '@/views/planManagement/equipmentCost/table/Detail'
