<template>
  <div>
    <!-- 基本设备材料列销信息 -->
    <a-card class="card" title="设备材料列销管理-新增" :bordered="false">
      <a-form :form="form">
        <a-row :gutter="16">
          <a-col :span="8">
...
import {handleDistribution,selectCondInfo,queryDeliveryNumber} from '@/api/onsite/distribution'
      ...
      setTimeout(() => {
        validateFields((err, values) => {
          ...
          if (type === 'save') {
            ...
            return handleDistribution(values, 'save').then(res => {
