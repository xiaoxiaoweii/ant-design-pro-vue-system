...
import { formStatusLabel, formStatusArray,exportPDF, exportPDFList, exportExcel, exportExcelList } from '@/api/common'
import { handleQueryButton } from '@/api/userMenu'
import { queryMaterialPriceList } from '@/api/pricepool/materialPrice'
  ...
  data () {
    return {
      ...
      loadData: parameter => {
        ...
        // parameter
        return queryMaterialPriceList(Object.assign(parameter, this.queryParam,{creator_org_id:this.$store.state.menu_key||0})).then(res => {
