...
import { queryWaterFacility,queryWater } from '@/api/onsite/equipLedger'
...
export default {
  ...
  data () {
    return {
      ...
      loadData: parameter => {
        ...
        let that=this
        // parameter
        return queryWaterFacility(Object.assign(parameter, this.queryParam
  ...
  methods: {
    async getList(x){
      const res = await queryWater({ code: x.code })
