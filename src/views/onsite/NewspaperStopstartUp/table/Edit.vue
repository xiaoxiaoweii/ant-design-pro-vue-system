...
import {handleNewspaperStopstartUp,queryOne,queryledger,selectCondInfo} from '@/api/onsite/newspaperStopstartUp'
      ...
      setTimeout(() => {
        validateFields((err, values) => {
          ...
          if (type === 'update') {
            ...
            return handleNewspaperStopstartUp(values, 'update').then(res => {
