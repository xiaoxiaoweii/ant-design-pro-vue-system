  ...
  <div>
    ...
    >
      ...
      <div slot="filterDropdown" slot-scope="{ setSelectedKeys, selectedKeys, confirm, clearFilters,column}" class="custom-filter-dropdown">
        ...
        <a-range-picker
          v-if="column.dataIndex==='create_date'||column.dataIndex==='check_time'"
          v-model="range "
          @change="onChange"
...
import { handlePurchase, exportToExcel , formStatusArray } from '@/api/safety/checkResult'
    ...
    columns () {
      ...
      return   [
        ...
        },
        {
          ...
          sorter: (a, b) => a.manage_code.length - b.manage_code.length
        },
        {
          title: '设备名称',
