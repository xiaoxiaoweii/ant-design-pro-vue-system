  ...
  <div>
    ...
    > 
      ...
      <div slot="filterDropdown" slot-scope="{ setSelectedKeys, selectedKeys, confirm, clearFilters,column}" class='custom-filter-dropdown'>
        ...
        <a-range-picker
          v-if="column.dataIndex==='verify_time'||column.dataIndex==='check_time'"
          v-model="range "
          @change="onChange"
...
import { handlePurchase, exportToExcel, formStatusArray } from '@/api/safety/question'
    ...
    columns () {
      ...
      return   [
        ...
        },
        {
          ...
          onFilter: (value, record) => record.check_time,
          ...
          sorter: (a, b) => a.check_time.split('-').join('') - b.check_time.split('-').join('')
        },
        {
          title: '受检查单位',
          dataIndex: 'orig',
          ...
          onFilter: (value, record) => record.orig.toLowerCase().includes(value.toLowerCase()),
          onFilterDropdownVisibleChange: (visible) => {
            if (visible) {
              setTimeout(() => {
                this.searchInput.focus()
        ...
        },
        {
          ...
          onFilter: (value, record) => record.verify_user_name.toLowerCase().includes(value.toLowerCase()),
          onFilterDropdownVisibleChange: (visible) => {
            if (visible) {
              setTimeout(() => {
                this.searchInput.focus()
...

        {
          ...
          onFilter: (value, record) => record.verify_time.toLowerCase().includes(value.toLowerCase()),
          onFilterDropdownVisibleChange: (visible) => {
            if (visible) {
              setTimeout(() => {
                // this.searchInput.focus()
           ...
           sorter: (a, b) => a.verify_time.split('-').join('') - b.verify_time.split('-').join('')
        },
        {
          title: '验证意见',
          dataIndex: 'corr_opinion',
          scopedSlots: {
            filterDropdown: 'filterDropdown',
            filterIcon: 'filterIcon',
            customRender: 'customRender',
          },
          onFilter: (value, record) => record.corr_opinion.toLowerCase().includes(value.toLowerCase()),
          onFilterDropdownVisibleChange: (visible) => {
            if (visible) {
              setTimeout(() => {
                this.searchInput.focus()
