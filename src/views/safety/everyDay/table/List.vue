  ...
  <div>
    ...
    >
      ...
      <div slot="filterDropdown" slot-scope="{ setSelectedKeys, selectedKeys, confirm, clearFilters,column}" class="custom-filter-dropdown">
        ...
        <a-range-picker
          v-if="column.dataIndex==='check_time'||column.dataIndex==='approvalDate'"
          v-model="range "
          @change="onChange"
...
import { handlePurchase, exportToExcel , formStatusArray} from '@/api/safety/everyDay'
