...
export default {
  ...
  data () {
    return {
      ...
      detailFields: ['code', 'car_name', 'spec', 'car_no', 'num', 'supplier_name', 'buckle_time1', 'planned_return_time1', 'expire1', 'running', 'braking', 'coupling_buffer', 'car_body', 'other', 'check_person', 'remark'],
      attachColumns: [
        // {
        //   title: '序号',
  ...
  watch: {
    $route (to, from) {
      ...
      if (from.path === '/equipmentMobilization/roadTransportList') {
        //
      }
    }
  },
  ...
  methods: {
    ...
    handleGetInfo () {
      ...
      if (data.id) {
        ...
        const formData = pick(data, ['create_date', 'created_at', 'creator_org_id', 'creator_org_name', 'creator_user_name', 'serial_number', 'code', 'car_name', 'spec', 'car_no', 'num', 'supplier_name', 'buckle_time1', 'planned_return_time1', 'expire1', 'running', 'braking', 'coupling_buffer', 'car_body', 'other', 'check_person', 'remark'])
      ...
      setTimeout(() => {
        validateFields((err, values) => {
          ...
          if (that.recording) {
            ...
            values.equipment_code = that.recording.equipment_code
